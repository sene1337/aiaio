...
export interface Projectile {
  ...
  age: number;
  /** the literal payload text — splashes at IMPACT (your own words) */
  label?: string;
  /** flight visuals: animated head glyphs + trail glyphs (symbols, not words) */
  flight?: { head: string[]; trail: string[] };
}
